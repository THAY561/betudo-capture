...
// Inicializa CSVs se não existirem
...
function salvarRound(roundId, maxMultiplier, arquivo, clientTime, clientDate) {
...
app.post('/collect', (req, res) => {
    const { key, roundId, maxMultiplier, game, clientTime, clientDate } = req.body || {};
    ...
    const saved = salvarRound(Number(roundId), Number(maxMultiplier), arquivo, clientTime, clientDate);
...
app.post('/api/clear', (req, res) => {
    ...
    console.log('[CLEAR] ' + arquivo + ' zerado');
